...
public class Vista {
   ...
   public  Registro solicitarDatosRegistro (){
       ...
       String diaPedido = scanner.nextLine();
        ...
        return new Registro(nombre, numeroDocumento, numeroCarnetBiblioteca, libro, diaPedido);
       
   }
   
   public String solicitarLibroAEliminar() {
       Scanner scanner = new Scanner(System.in);
   ...
   public void mostrarRegistro(Registro registro) {
        ...
        mostrarMensaje("Dia de entrega: " + registro.getDiaEntrega());
        mostrarMensaje("");
    }
